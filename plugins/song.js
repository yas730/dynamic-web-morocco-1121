...
⬡ S: ${ago}
⬡ E: ${url}
╰────────⬣`, author.trim(), await( await conn.getFile(thumbnail)).data, ['📽 VIDEO', `${usedPrefix}getvid ${url} 360`], false, { quoted: m, 'document': { 'url':'https://wa.me/' },
...
title: `bot IS HERE ♥...`,
body:author,
sourceUrl: 'http://wa.me/', thumbnail: await ( await conn.getFile(thumbnail)).data
  }
 } 
})
